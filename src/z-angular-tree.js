...
angular
    ...
    .directive("zTreeNodeChildren",['$compile','$templateCache','treeConfig', function($compile, $templateCache, treeConfig) {
        return {
            restrict: 'AE',
            template: '<div class="z-tree-node-children" ng-class="{\'z-tree-root-level\':void(0)===$model.$nodeLevel}">',
            replace:true,
            scope:true,
            controller: function() {
        ...
        return {
            ...
            link: function(scope, element, attrs, controller) {
                ...
                scope.transcludeScope.$model = {
                    ...
                    $collapsed:scope.node[rootScope.options.childrenField].length===0?true:rootScope.options.defaultCollapsed,
                    $hasSelect:false,
                    $selected:false,
